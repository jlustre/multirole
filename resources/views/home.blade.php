<x-app-layout>
    @section('hero')
        <div class="w-full py-32 text-center">
            <h1 class="text-2xl font-bold text-center text-gray-700 md:text-3xl lg:text-5xl">
                Welcome to <span class="text-yellow-500">AsBeez</span> <span class="text-gray-900"> Blogs</span>
            </h1>
            <p class="mt-1 text-lg text-gray-500">Best Blogs in the universe</p>
    ...
    <div class="mb-10">
        ...
        <div class="w-full mb-5">
            <div class="grid w-full grid-cols-4 gap-10 gap-y-32">
